...
import { useParams } from 'next/navigation';  // Correct hook from next/navigation for dynamic params
import { getSpotifyUserProfile } from '@/lib/spotify';  // import the helper function
import { getAllPosts } from '@/lib/supabase';  // assuming you're fetching posts for the user
...
export default function UserPage() {
  ...
  const { id } = useParams();  // Use the new useParams hook for getting the dynamic route params
